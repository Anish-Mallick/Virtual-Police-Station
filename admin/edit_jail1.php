...
include 'mysql.php';
$fname = $_GET['value'];
$sql = "select * from jail where fname = '$fname'";
        ...
        <div class="container-fluid">
            ...
            <div class="row" id="main" >
                <div class="col-sm-12 col-md-12 well" id="content">
                  ...
                  <input type="text" class = "form-control" name = "reason" value = "<?php echo $reason; ?>"><br>
                  <label for="">previous Case</label>
                  <input type="text" class = "form-control" name = "prev" value = "<?php echo $prv; ?>"><br>
                  <label for="">date</label>
                  <input type="text" class = "form-control" name = "date" value = "<?php echo $date; ?>"><br>
                  <label for="">Officer</label>
                  <input type="text" class = "form-control" name = "officer" value = "<?php echo $officer; ?>"><br>
...
if(isset($_POST['submit'])){
    ...
    $sql2 = "update jail set lname = '$lname',
                                        reason = '$reason',
                                        previous_case='$prev',
                                        date = '$date',
                                        officer = '$officer' where fname = '$fname';
                                        ";
                                        ...
                                        if($query2){
                                            ...
                                            echo "<script> window.location = 'edit_jail.php' </script>";
                                        }
}
