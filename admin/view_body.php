...
<div id="wrapper">
    ...
    <div class="panel-heading">     <h3 class = "text-center">List of Unidentified Body</h3>    </div>
    <div class="panel-body">
    <form action="view_body_action.php" method = "POST">
    
    <input type="text" style = "width:500px;" name = "search" placeholder = "Search using Firstname,Lastname,Email" class = "form-control">
