    ...
    <div class="row">
        ...
        <div class="col-md-10 col-md-offset-1">
            ...
            <div class="panel panel-default panel-table">
              ...
              <h3 class = 'text-center'>List of Available Officer</h3>
                <div class="row">
              ...
              <?php
              include 'mysql.php';
              $sql = "select * from  officer_profile";

$query = mysqli_query($con,$sql);
$count = mysqli_num_rows($query);
if($count==0){
    echo "<h3 style = 'margin-left:200px;'> <strong>  No data available </strong> </h3>";
}
else{
...
?>
                <table class="table table-striped table-bordered table-list">
                  ...
                  <tbody>
                          ...
                          <tr>
                            <td align="center">
                              <a class="btn btn-default" href = "edit_officer1.php?value=<?php echo $fname?>"><em class="fa fa-pencil"></em></a>
                              <a href = "edit_officer_del.php?value=<?php echo $fname ;?>" class="btn btn-danger"><em class="fa fa-trash"></em></a>
                            </td>
