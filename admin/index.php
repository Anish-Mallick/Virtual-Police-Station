    ...
    <div class="col-md-4">
      <section class="login-form">
        <form method="post" action="#" role="login">
         <h2 style = "text-align:center;"><strong>Admin Login</strong></h2>
...
$_SESSION['email'] = $email;
    $sql = "select * from admin_field where email = '$email' and password = '$password'";
