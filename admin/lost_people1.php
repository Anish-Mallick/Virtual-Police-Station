...
include 'mysql.php';
$name = $_GET['value'];
$sql = "select * from lost_people where name = '$name'";
        ...
        <div class="container-fluid">
            ...
            <div class="row" id="main" >
                <div class="col-sm-12 col-md-12 well" id="content">
                  ...
                  <input type="text" class = "form-control" name = "reward" value = "<?php echo $reward; ?>"><br>
...
if(isset($_POST['submit'])){
   ...
   $desc2 = $_POST['desc'];
   $reward2 = $_POST['reward'];
   $number2 = $_POST['number'];


    $sql2 = "update lost_people set description = '$desc2',reward = '$reward2',contact_number = '$number2' where name = '$name';
                                        ";
                                        ...
                                        if($query2){
                                            ...
                                            echo "<script>  window.location = 'lost_people_edit.php' </script>";
                                        }
}
