...
<div id="wrapper">
    ...
    <div class="panel-heading">   <h3 class = "text-center">Data of the Jailed People</h3>  </div>
    <div class="panel-body">
    <form action="view_jail_action.php" method = "POST">
...
if($count==0){
    ...
    while($result = mysqli_fetch_array($query)){
        ...
        $previous_case = $result['previous_case'];
        $date = $result['date'];
...
<th>LastName</th>
<th>Reason</th>
<th>Physical Description of The Suspect:</th>
<th>Date_arrested</th>
<th>Pic</th>
<th>OfficerName</th>
