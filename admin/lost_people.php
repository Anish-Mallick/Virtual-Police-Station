...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        ...
        <h3 class = 'text-center'>Enter The Information of the Lost people</h3>
            <!-- Page Heading -->
            <?php
...
if(strlen($number)>3){
    ...
    $numberErr = "A mobile Number will be of Length of 11";
}


  

    if(empty($nameErr) && empty($numberErr) && empty($descErr)){
        $sql ="insert into lost_people(Name,pic,description,reward,contact_number) values ('$name','$pic','$desc','$reward','$number')";
        ...
        echo "<script> alert('check your info') </script>";
    }
...
?>
            ...
            <div class="row" id="main" >
                <div class="col-sm-12 col-md-12 well" id="content">
                    ...
                    <label> Pic </label>
                    <input type="file" name = "image" id = "image"  value = "<?php echo (isset($_POST['image'])?$_POST['image']:'') ?>" required><br>
                    <label for="">Description</label>
                    <input type="text" name = "desc" class = "form-control" value = "<?php echo (isset($_POST['desc'])?$_POST['desc']:'') ?>" required><br>
                    <span style = "color:red"> <?php echo $descErr; ?></span> <br>
                    <label for="">Reward</label>
                    <input type="number" name = "reward" class = "form-control" value = "<?php echo (isset($_POST['reward'])?$_POST['reward']:'') ?>" required><br>
                    <label for="">contact_number</label>
                    <input type="number" name = "number" class = "form-control" value = "<?php echo (isset($_POST['number'])?$_POST['number']:'') ?>" required><br>
                    <span style = "color:red;"><?php echo $numberErr ;?></span> <br>
                    <input type="submit" style = "margin-left:500px;" name = "submit" value = "submit" class = 'btn btn-success'>
