...
include 'mysql.php';
$token = $_GET['value'];
$sql = "select * from unidentified_body where token = '$token'";
        ...
        <div class="container-fluid">
            ...
            <div class="row" id="main" >
                <div class="col-sm-12 col-md-12 well" id="content">
                  ...
                  <input type="text" class = "form-control" name = "token" value = "<?php echo $token; ?>" disabled><br>
                  <label for="">Description</label>
                  <input type="text" class = "form-control" name = "desc" value = "<?php echo $desc; ?>"><br>
                  <label for="">contactnumber</label>
                  <input type="text" class = "form-control" name = "number" value = "<?php echo $number; ?>"><br>
...
if(isset($_POST['submit'])){
    ...
    $sql2 = "update unidentified_body set token = '$token',description = '$desc',contact_number='$number' where token = '$token';
                                        ";
                                        ...
                                        if($query2){
                                            ...
                                            echo "<script> window.location = 'unidentified_body_edit.php' </script>";
                                        }
}
