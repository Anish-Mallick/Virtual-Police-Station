...
<div id="wrapper">
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
            <ul class="nav navbar-nav side-nav">
                ...
                <li>
                    <a href="#" data-toggle="collapse" data-target="#submenu-4"><i class="fa fa-fw fa-star"></i>  News <i class="fa fa-fw fa-angle-down pull-right"></i></a>
                    <ul id="submenu-4" class="collapse">
  ...
  <div class="panel-heading">  <h3 class ='text-center'>create news</h3>  </div>
  <div class="panel-body">
  
  <form action="" method = "POST">
  
  <input type="text" name = "title" class = "form-control" placeholder = "Title of the news" required> <br>
  <input type="text" name = "sub" class = "form-control" placeholder = "Give the sub of the news" required> <br>
  <textarea name="full" id="full" title = "has to be more than 250 words" cols="30" rows="10" placeholder = "Give all the news details" class = "form-control"></textarea> 

  <input style = "width:20em;margin-left:350px;" type="submit" name  ="submit" class = "btn btn-success">
  </form>
...
if(strlen($full)>250){
    $sql = "insert into news(id,title,sub,full,date) values('','$title','$sub','$full','$date')";
    ...
    echo "<script> alert ('full article has to be more than 250 words') </script>";
}
