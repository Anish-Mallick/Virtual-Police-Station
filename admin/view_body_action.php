...
<div id="wrapper">
    ...
    <input type="text" style = "width:500px;" name = "search" placeholder = "Search using token no" class = "form-control">
...
include 'mysql.php';
$sql = "select * from unidentified_body where token = '$search'";
