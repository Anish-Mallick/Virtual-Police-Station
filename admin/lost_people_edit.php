    ...
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <div class="panel panel-default panel-table">
              ...
              <h3 class = "text-center">Lost People List</h3>
                <div class="row">
...
<table class="table table-striped table-bordered table-list">
                  ...
                  <tbody>
                          ...
                          <tr>
                            <td align="center">
                              <a class="btn btn-default" href = "lost_people1.php?value=<?php echo $name?>"><em class="fa fa-pencil"></em></a>
                              <a href="lost_people_del.php?value=<?php echo $name; ?>" class="btn btn-danger"><em class="fa fa-trash"></em></a>
                            </td>
                            <td ><?php echo $name ; ?></td>
                            <?php
