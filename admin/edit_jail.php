    ...
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <div class="panel panel-default panel-table">
              ...
              <h3 class = 'text-center'>List of People Jailed </h3>
                <div class="row">
...
if($count==0){
    echo "<h3 class = 'text-center'>  No value available </h3>";
}
else{
...
?>
    <table class="table table-striped table-bordered table-list">
                  ...
                  <tbody>
                          <tr>
                            <td align="center">
                              <a class="btn btn-default" href = "edit_jail1.php?value=<?php echo $fname?>"><em class="fa fa-pencil"></em></a>
                              <a href = "jail_delete.php?value=<?php echo $fname; ?>" class="btn btn-danger"><em class="fa fa-trash"></em></a>
                            </td>
