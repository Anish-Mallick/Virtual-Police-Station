...
<html lang="en">
<head>
  <title>Sub-inspector Login panel</title>
  <meta charset="utf-8">
...
$joined_year = $result = $result['joined_year'];
 ?>
				...
				<li class="dropdown ">
					<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">
						...
						<ul class="dropdown-menu" role="menu">
							...
							<li class="dropdown-header"><a href="view_sub_profile.php">View profile</a></li>
		...
		<nav class="navbar navbar-default" role="navigation">
			...
			<div class="side-menu-container">
				<ul class="nav navbar-nav">
					...
					<li><a ><span class="glyphicon glyphicon-plane"></span> My profile</a></li>
						
                    <li><a href="assgn_case.php"><span class="glyphicon glyphicon-plane"></span> Assigned case</a></li>
					<li><a href="case_report.php"><span class="glyphicon glyphicon-plane"></span> Case Report</a></li>
					<!-- Dropdown-->
...
<div class="bot-border"></div>
<hr>
<div class="col-sm-5 col-xs-6 tital " >OfficerId</div><div class="col-sm-7"><?php echo $id; ?></div>
<hr>
<hr>
...
<?php
	...
	echo "<script> window.location = 'sub_inspector_login.php'  </script>";
}
?>